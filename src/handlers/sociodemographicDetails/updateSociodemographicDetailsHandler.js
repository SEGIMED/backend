...
const updateSociodemographicDetailsHandler = async (patchSociodemographicBody) => {


    try {
        const [updateSociodemographicDetail, created] = await SociodemographicDetails.findOrCreate({
            where: {
