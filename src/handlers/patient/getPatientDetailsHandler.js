import {
    AnthropometricDetails, AppointmentScheduling, Backgrounds,
    ...
    CatMeasureUnit,
    CatMedicalBackgroundType, CatMedicalSpecialty,
    CatPulmonaryArterialHypertensionRisk,
    CatPulmonaryHypertensionGroup, CatSchedulingStatus,
    CatSurgicalRisk,
    CatVitalSignMeasureType, MedicalEvent,
...
const getPatientDetailsHandler = async (id) => {
    try {
        ...
        // console.log(patientDetails.sociodemographicDetails)
