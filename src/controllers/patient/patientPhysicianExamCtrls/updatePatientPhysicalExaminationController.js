import updatePatientPhysicalExaminationHandler from "../../../handlers/patient/patientPhysicianExam/updatePatientPhysicalExaminationHandler.js";

const updatePatientPhysicalExaminationController = async (req, res) => {
  try {
    const updatePhysicalExamination = req.body;
    const updatedExamination = await updatePatientPhysicalExaminationHandler(
