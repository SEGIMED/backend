import createPatientPhysicalExaminationHandler from "../../../handlers/patient/patientPhysicianExam/createPatientPhysicalExaminationHandler.js";

const createPatientPhysicalExaminationController = async (req, res) => {
  try {
    const newPhysicalExamination = req.body;
    const Examination = await createPatientPhysicalExaminationHandler(
