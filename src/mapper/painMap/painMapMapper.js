export const mapPainMap = (painMap) => {
  ...
  const mappedPainMap = {
    ...
    painDuration: painMap.painDurationDetail
      ? painMap.painDurationDetail.name
      : "",
    ...
    painFrequency: painMap.painFrequencyDetail
      ? painMap.painFrequencyDetail.name
      : "",
    painRecorderUser: {
      painRecorderUserId: painMap.painRecorderUser
        ? painMap.painRecorderUser.id
        : "",
      painRecorderUserName: painMap.painRecorderUser
        ? painMap.painRecorderUser.name
        : "",
      painRecorderUserLastname: painMap.painRecorderUser
        ? painMap.painRecorderUser.lastname
        : "",
    },
  };
