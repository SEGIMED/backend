...
PatientPulmonaryHypertensionGroup.belongsToMany(CatPulmonaryHypertensionGroup, {
  through: PatientPulmonaryHypertensionGroupMapping,
  foreignKey: "patient_group_id",
  otherKey: "group_id",
});
CatPulmonaryHypertensionGroup.belongsToMany(PatientPulmonaryHypertensionGroup, {
  through: PatientPulmonaryHypertensionGroupMapping,
  foreignKey: "group_id",
  otherKey: "patient_group_id",
});
